...
func TestPProfListenOn_defaultIsLoopback(t *testing.T) {
	field, ok := reflect.TypeOf(RootFlags{}).FieldByName("PProfListenOn")
	require.True(t, ok, "RootFlags.PProfListenOn must exist")
