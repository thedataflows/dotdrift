---
type: Checklist
title: Definition of done v0.1.0
description: Exit criteria for the first release.
...
- [x] Milestones [M0](/milestones/m0-scaffold.md)–[M9](/milestones/m9-polish.md) complete
- [x] `go test ./...` green offline
